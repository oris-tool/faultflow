...
/**
 * OR operator, used in the definition of boolean expressions for error mode activation conditions, that represents the
 * OR logical operator, which evaluates true if at least one of its sub-elements is true.
 */
public class OR extends Operator {
    ...
    /**
     * Method used to add a boolean expression as a sub-element in the OR formula
     *
     * @param booleanExpression a {@link BooleanExpression} instance that composes the OR formula
     */
     ...
     *
     * @return a boolean value, true if at least one of the child of the operator is in a true state and false otherwise
     */
    @Override
    ...
    /**
     * Method used to export the OR formula as a string
     *
    ...
    /**
     * Method used to export the OR formula as a simple string
     *
     * @return a {@link String} that represents a literal conversion of the formula
     */
    @Override
